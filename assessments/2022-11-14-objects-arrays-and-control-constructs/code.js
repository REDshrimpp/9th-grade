...
const fillTimesTable = (table) => {
  for(let outerArray = 0; outerArray < table.length; outerArray++) {
  for(let innerArray = 0; innerArray < table[innerArray].length; innerArray++) {
    table[outerArray][innerArray] = outerArray * innerArray
  }
  }
  return table
};
